...
public class ConditionalExpression extends OperatorExpression {
	...
	private TypeBinding expectedType = null;//Operator overload, for generic function call
...
//			this.constant = Constant.NotAConstant;
			...
			this.originalValueIfTrueType = this.valueIfTrue.resolvedType; //resolveType(scope);

			if (this.valueIfFalse instanceof CastExpression) this.valueIfFalse.bits |= DisableUnnecessaryCastCheck; // will check later on
			this.originalValueIfFalseType = this.valueIfFalse.resolvedType; //resolveType(scope);
